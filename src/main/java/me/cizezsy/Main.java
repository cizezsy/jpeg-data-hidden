...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            LSBDataProducer lsbDataProducer = new LSBDataProducer(data.getBytes("utf-8"));
            JPEGImage image = new JPEGImageReader(new FileInputStream("C:\\Users\\Administrator\\Desktop\\aaa.jpg"), lsbDataProducer).readImage();

            try (FileOutputStream fos = new FileOutputStream("C:\\Users\\Administrator\\Desktop\\test_out.jpg")) {
